        ...
        <nav class="d-flex justify-content-between mx-3 my-2">
            ...
            <b-button-group>
                ...
                <Dropdown
                    ...
                    <DropdownItem v-b-modal:delete-history-modal :title="l('Permanently Delete History')">
...
import { Dropdown, DropdownItem, DropdownDivider, DropdownText } from "@/componentLibrary";
